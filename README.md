...
RainPrediction - Performs a statistical classification of weather conditions under which next-day precipitation may occur. See the document ApplyingC5.pdf in the root directory. If one thinks it is about to rain, one may wish to delay irrigation. NOTE: The zip for this item could not be uploaded to GitHub in non-corrupted form. Download from http://InformationAnthology.net/RainPrediction.zip
