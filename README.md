...
What is coming next: So far, we have been working with historical data. That is good for testing equations and networks. The next version of the software will draw its data from real-time feeds. A reliable and accurate source is needed. Since the author knows of no other sources, data from the US National Weather Service will be used. FAO-56's general tables will still be applied as before. They give parameters for sweet corn, a crop often grown in the US.
